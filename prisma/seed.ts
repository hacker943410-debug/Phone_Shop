...
async function main() {
  await prisma.$transaction([
    ...
    prisma.inventoryColorOption.deleteMany(),
  ...
  await prisma.inventoryColorOption.createMany({
    data: [
      { id: "inventory-color-titan-gray", name: "Titan Gray", isActive: true },
      { id: "inventory-color-blue", name: "Blue", isActive: true },
      { id: "inventory-color-mint", name: "Mint", isActive: true },
      { id: "inventory-color-awesome-navy", name: "Awesome Navy", isActive: true },
      { id: "inventory-color-icy-blue", name: "Icy Blue", isActive: true },
      { id: "inventory-color-black", name: "Black", isActive: true },
      { id: "inventory-color-silver-shadow", name: "Silver Shadow", isActive: true },
    ],
  });
  ...
  await prisma.inventoryItem.createMany({
    data: [
      ...
      },
      {
        ...
        color: "Mint",
        capacity: "512GB",
        serialNumber: "SN-ZF6-001",
        modelNumber: "SM-F741N",
        costAmount: 1180000,
        status: InventoryStatus.SOLD,
      ...
      },
      {
        ...
        color: "Awesome Navy",
        capacity: "256GB",
        serialNumber: "SN-A56-001",
        modelNumber: "SM-A566N",
        costAmount: 620000,
        status: InventoryStatus.SOLD,
