...
<execution_context>
@C:/Project/PhoneShop/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @C:/Project/PhoneShop/.codex/get-shit-done/workflows/add-tests.md end-to-end.
