...
<execution_context>
@C:/Project/PhoneShop/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@C:/Project/PhoneShop/.codex/get-shit-done/workflows/add-phase.md`.
