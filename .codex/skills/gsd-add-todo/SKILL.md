...
<execution_context>
@C:/Project/PhoneShop/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@C:/Project/PhoneShop/.codex/get-shit-done/workflows/add-todo.md`.
