...
<execution_context>
@C:/Project/PhoneShop/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/Project/PhoneShop/.codex/get-shit-done/workflows/check-todos.md`.
