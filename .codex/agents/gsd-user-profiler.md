...
<reference>
@C:/Project/PhoneShop/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Project/PhoneShop/.codex/get-shit-done/references/user-profiling.md` to load:
