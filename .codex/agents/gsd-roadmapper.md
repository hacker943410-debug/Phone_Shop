...
Reference full template: `C:/Project/PhoneShop/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Project/PhoneShop/.codex/get-shit-done/templates/state.md`.
