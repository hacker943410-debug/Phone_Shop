...
export const interactiveButtonClassName =
  "inline-flex cursor-pointer items-center justify-center rounded-xl text-sm font-semibold transition-[transform,box-shadow,background-color,border-color,color] duration-150 ease-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-100 hover:-translate-y-px hover:shadow-[0_16px_28px_-22px_rgba(15,23,42,0.45)] active:translate-y-0 active:shadow-[inset_0_1px_2px_rgba(15,23,42,0.14)] disabled:cursor-not-allowed disabled:translate-y-0 disabled:shadow-none";

export const primaryButtonClassName = `${interactiveButtonClassName} border border-blue-700 bg-blue-600 text-white hover:border-blue-800 hover:bg-blue-700 disabled:border-blue-300 disabled:bg-blue-300`;
...
export const secondaryButtonClassName = `${interactiveButtonClassName} border border-stone-300 bg-white text-slate-700 hover:border-blue-300 hover:bg-blue-50`;
